		...
		setVisible(true);
             ...
             try
	         {
         		...
         		Connection c= DriverManager.getConnection("jdbc:mysql://localhost:3306/CMS","root","Kingtp@36");
    					...
    					String str= "SELECT * FROM Employee WHERE E_Id=\'"+EId+"\'";
		...
		public void actionPerformed(ActionEvent ae)
		{
			...
			else if (srcObj =="update")
			{
			 ...
			 else
			 {
				...
				String str="Update Employee set E_Name = \'"+JTFName.getText()+"\',E_Addr = \'"+JTFAddr.getText()+"\',E_Loc = \'"+JTFLocat.getText()+"\',E_Phone="+JTFPhone.getText()+",E_Process = \'"+JTFProcess.getText()+"\' WHERE E_Id=\'"+JTFId.getText()+"\'";
					    s.executeUpdate(str);

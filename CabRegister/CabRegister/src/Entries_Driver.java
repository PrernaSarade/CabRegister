...
public class Entries_Driver extends JFrame 
{
	...
	ActionListener JBActionListener = new ActionListener()
	{
		public void actionPerformed(ActionEvent ae)
		{
			...
			if(srcObj.equals("cancel"))
			{
				//	new tabbedpane();
				dispose();
			}
			else if(srcObj.equals("reset"))
			{
				JTFId.setText("");
				JTFName.setText("");
				JTFAddr.setText("");
				...
				if(flag7==true)
				{
					...
					if(flag==false)
					{
						try
						{
							...
							rs=stmt.executeQuery("select * from Del_Driver");
							if(rs.next()==false)
							{
								flag1=false; 
						...
						if(flag1==false)
						{
							...
							ps.setString(3,JTFAddr.getText());
							ps.setString(4,JTFTravAge.getText());
							ps.setString(5,JTFPhone.getText());
							ps.setString(6,JTFVno.getText());
							ps.setString(7,JTFJoin.getText());
							ps.executeUpdate();
							System.out.println("two");
							PreparedStatement ps2 = c.prepareStatement("insert into Cab values(?,?,?)");
							System.out.println("Program executed success fully");
							ps2.setString(1,JTFVno.getText());
							ps2.setString(2,JTFCname.getText());
							ps2.setString(3,JTFCcap.getText());

...
public class Entries_Emp extends JFrame //implements ActionListener
{
	...
	public Entries_Emp()
    {
		...
		JBUpdt.setMnemonic(KeyEvent.VK_A);
    ...
    ActionListener JBActionListener = new ActionListener()
	{
		public void actionPerformed(ActionEvent ae)
		{
			...
			else if(srcObj=="Save")
			{
			  ...
			  JOptionPane.showMessageDialog(null,"Fill all the Fields of Form","Error iin Adding",JOptionPane.ERROR_MESSAGE);
			 else
			 {
				...
				{       
                                    ...
                                    if(mat.find() && mat1.find())
                                       ...
                                       {
                                                JOptionPane.showMessageDialog(null,"Check ID. It should be like : E100","Error in Adding",JOptionPane.ERROR_MESSAGE);
                                        JTFId.setText("");flag7=false;
                                        }
                                       mat=pat.matcher(JTFAddr.getText());
                                      flag6=mat.matches();
                                      //  flag6=matches(pat,JTFPhone.getText());
                                       if(flag6)
                                       {}
                                        else
                                       {
                                     ...
                                     // pat=Pattern.compile("[0-9]+");
                                      ...
                                      //  flag6=matches(pat,JTFPhone.getText());
                                       ...
                                       {
                                                JOptionPane.showMessageDialog(null,"Check Process Name.","Error in Adding",JOptionPane.ERROR_MESSAGE);
                                    ...
                                    mat=pat.matcher(JTFLocat.getText());
                                      flag6=mat.matches();
                                       ...
                                       {
                                                JOptionPane.showMessageDialog(null,"Check Location","Error in Adding",JOptionPane.ERROR_MESSAGE);
                                        JTFLocat.setText("");
                                        flag7=false;
                                        }     
                                       if(flag7==true)
	    			...
	    			PreparedStatement stmt1 = c.prepareStatement("insert into Employee values(?,?,?,?,?,?)");
	    			stmt1.setString(1,JTFId.getText());
	    			stmt1.setString(2,JTFName.getText());
	    			stmt1.setString(3,JTFAddr.getText());
	    			stmt1.setString(4,JTFPhone.getText());
	    			stmt1.setString(5,JTFProcess.getText());
	    			stmt1.setString(6,JTFLocat.getText());
	    			stmt1.executeUpdate();
    			...
    			{
    				JOptionPane.showMessageDialog(null,"Employee : "+JTFId.getText()+" is already present","Error in Adding",JOptionPane.ERROR_MESSAGE);
    						JTFId.setText("");
    			}	
				} }
				catch(Exception e)

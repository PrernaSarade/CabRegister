...
//	JButton JBAdd = new JButton("Add");
	...
	//	JBPrint.addActionListener(this);
		...
		{
			empl=Driverarray[j];
		    str= "SELECT * FROM Employee WHERE E_ID=\'"+empl+"\'";
		...
		//JLSign.setBounds(80,320,170,80);
		//panel.add(JTFSign);
...
/*	public void actionPerformed(ActionEvent event)
	...
	ActionListener JBActionListener = new ActionListener()
	{
		...
		{
			//JTextField chktf = (JTextField)ae.getSource();
			String str;
			...
			{
			PrintUtilities p=new PrintUtilities(panel);
			//p.printComponent(panel);
				//new usePrinter();
...
public void toolTips()
{
	...
	JBPrint.setToolTipText("Click This Button To Print This Page");
	JBBack.setToolTipText("Click This Button To Go Back To Main Admin Page");
	JTFDriverName.setToolTipText("Enter The Driver Name");
	JTFCompName.setToolTipText("Enter The Company Name");
	JTFProcess.setToolTipText("Enter The Travel Agencies");
	JTFCabNo.setToolTipText("Enter Cab Number ");
	JTFDriverNo.setToolTipText("Enter The Driver Number And Hit Enter");
}
...
class emp extends JFrame implements ActionListener
{
	...
	JLabel JLBanner = new JLabel("Please select the required Employee.");
    ...
    public emp(String Did,int cap)
    {
    	Drid=Did;
    	capacity=cap;
    	setTitle("Adding of Employee to Rooster");
...
//		JPContainer.add(JTFPass);
		...
		JBEnter.setMnemonic(KeyEvent.VK_E);
    	...
    	did=(String)jcb.getSelectedItem();
    		...
    		{			  
    					   ...
    					   {  if(Driverarray[j]==null)
    					     ...
    					     if(flag1==true)
    					     {
    					       JOptionPane.showMessageDialog(null,"Employee : "+(String)jcb.getSelectedItem()+" is all ready added to Roster","Error in adding",JOptionPane.ERROR_MESSAGE);
    						   JTFId.setText("");
    					     }
    					     else
    					     {
    					  ...
    					  if(flag3==true)
    					  {
    					    ...
    					    int res=JOptionPane.showConfirmDialog((Component)null,"Do You Want Add Employee to Rooster ?","Choose yes or no",JOptionPane.YES_NO_OPTION);
    					    String ObjButtons[] = {"Yes","No"};
		   				    if(res ==JOptionPane.YES_OPTION)
		   				    {  JTFId.setText("");
    					      //new Employee1(JTFId.getText());
		   				    }
    					    else
    					    {	//table(Did,Driverarray)
...
public class table1 extends JFrame implements ActionListener
{
	...
	int cap;	 
	JLabel JLPic = new JLabel(new ImageIcon("images/delete.png"));
	JLabel JLBanner = new JLabel("Please select the required Driver ID.");
    ...
    public table1()
    {
       ...
       {}
		...
		JBEnter.setToolTipText("Enter to check");
		JBReset.setToolTipText("Resets all the fields");
		JBCancel.setToolTipText("Return back to the main admin page");

 ...
 class Admin1 extends JFrame
{
	...
	JLabel JLAdminPassConf = new JLabel("Password confirm:");
	...
	JLabel StatusLabel = new JLabel("CREATED BY Prerna Sarade TYBCS :VP COLLEGE",JLabel.CENTER);
	...
	public Admin1(String adminid)
    {
		...
		JLAdminPassConf.setFont(new Font("Dialog",Font.PLAIN,12));
...
public class updateadmin extends JFrame implements ActionListener
{
	...
	JLabel JLBanner = new JLabel("Please fill the required field carefully");
    	...
    	if(ae.getSource() == JBEnter || ae.getSource() == JTFPass)
    	{
    		...
    		else
    		{
    				try
					{
    					...
    					{
    						JOptionPane.showMessageDialog(null,"Invalid Admin ID or Password","Error in Searching",JOptionPane.ERROR_MESSAGE);
    						//JOptionPane.showMessageDialog(null,"Admin : "+JTFId.getText()+" is not present","Error in Updating",JOptionPane.ERROR_MESSAGE);
